...
| Home | Preparation | Live Analysis | Results |
| :---: | :---: | :---: | :---: |
| ![Home](https://via.placeholder.com/150x300?text=Home) | ![Prep](https://via.placeholder.com/150x300?text=Prep) | ![Recording](https://via.placeholder.com/150x300?text=Recording) | ![Score](https://via.placeholder.com/150x300?text=Score) |

*(Add your actual screenshots here for maximum impact during the presentation)*
