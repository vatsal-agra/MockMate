  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: loading
          ...
          : sessions.isEmpty
              ? const Center(child: Text("No sessions yet. Record your first answer!"))
              : ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    final s = sessions[i];
                    return ListTile(
                      title: Text("Score ${s.totalScore.toStringAsFixed(0)}/100"),
                      subtitle: Text(
                      ...
                      onTap: () {
                        ...
                        showDialog(
                          ...
                          builder: (_) => AlertDialog(
                            title: Text("Session ${s.totalScore.toStringAsFixed(0)}/100"),
                            content: Column(
                              mainAxisSize: MainAxisSize.min,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: s.tips.map((t) => Padding(
